...
function sendVerificationMail($toEmail, $verifyCode) {
    ...
    try {
        ...
        $verifyLink = "http://localhost/bionluk-ecommerce/backend/auth/verifyEmailUser.php?code=$verifyCode";
        $mail->Body = "Merhaba,<br><br>Mail doğrulama için lütfen aşağıdaki bağlantıya tıklayarak hesabınızı doğrulayın:<br><a href='$verifyLink'>$verifyLink</a>";
